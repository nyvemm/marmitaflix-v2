  ...
  return (
    <QueryClientProvider client={client}>
      <Head>
        ...
        <meta name="description" content="Baixe filmes e séries de forma simples e rápida utilizando torrents" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Marmitaflix" />
        <meta property="og:image" content="/og-image.png" />
        <meta property="og:url" content="https://marmitaflix.vercel.app" />
        <meta property="og:description" content="Baixe filmes e séries de forma simples e rápida utilizando torrents" />
        ...
        <meta property="twitter:description" content="Baixe filmes e séries de forma simples e rápida utilizando torrents" />
